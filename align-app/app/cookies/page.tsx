    ...
    <div className="min-h-screen flex flex-col bg-dark-900">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 py-8">
        <p className="ui-subtitle text-sm mb-4">
          ...
          <Link href="/terms" className="text-brand-700 font-medium hover:text-brand-600 hover:underline">
        ...
        <h1 className="ui-page-title text-2xl mb-8">{legal.cookiesTitle}</h1>
